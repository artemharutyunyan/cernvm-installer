  ...
  :QWidget(parent)
{
  ...
  /*
  QLabel* releaseSourceMenuLabel = new QLabel(tr("CernVM releases source:"));
  releaseSourceMenu = new QComboBox();
  releaseSourceMenu->insertItem (0, conf.getReleaseSource()); 
  releaseSourceMenu->insertItem (1, "http://blah.blah.blah/kuku/2");
  Q_ASSERT(connect (releaseSourceMenu, SIGNAL(currentIndexChanged(int)), this, SLOT(changeReleaseSourceMenu(int))));
  */
  ...
  /*
  configLayout->addWidget (releaseSourceMenuLabel, 6, 0);
  configLayout->addWidget (releaseSourceMenu, 7, 0, 1, 2);
  */

  configLayout->addWidget (showDevCheckBox, 8, 0);


  configLayout->addWidget (resetButton, 9, 1);
...
/*
void CVMIConfigPage::changeReleaseSourceMenu(int)
{}
*/
